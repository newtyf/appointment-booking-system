...
class CulqiPaymentService:
    ...
    async def create_charge(
        ...
        logger.info(
            f"Creando cargo en Culqi: {description} - Monto: {amount/100} {currency}")
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                logger.info(
                    f"Cargo creado exitosamente: {charge_data.get('id')}")
            ...
            raise ValueError(
                "Error de conexión con el procesador de pagos") from e
    ...
    async def get_charge(self, charge_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ValueError(
                "No se pudo obtener la información del cargo") from e
